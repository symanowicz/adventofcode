...
func main() {
	puzz := map[string]puzzle{
		"2015 1": puzzle{2015,1,"2015/1","End Floor: %d\nEnter Basement at Position: %d\n",Y2015_01},
		"2015 2": puzzle{2015,2,"2015/2","Total Wrapping Paper: %d\nTotal Ribbon: %d\n",Y2015_02},
		"2015 3": puzzle{2015,3,"2015/3","Houses Visited This Year: %d\nHouses Visited Next Year: %d\n",Y2015_03},
		"2015 4": puzzle{2015,4,"2015/4","5 0s: %d\n6 0s: %d\n",Y2015_04},
		"2015 5": puzzle{2015,5,"2015/5","Nice Strings: %d\nNicer Strings: %d\n",Y2015_05},
		"2015 6": puzzle{2015,6,"2015/6","Lights Lit: %d\nTotal Brightness: %d\n",Y2015_06},
		"2015 7": puzzle{2015,7,"2015/7","Signal a: %d\nundefined: %d",Y2015_07},
	}
